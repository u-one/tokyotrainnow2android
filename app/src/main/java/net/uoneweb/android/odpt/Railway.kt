...
data class Railway(
    ...
    @SerializedName("odpt:color") val color: String= "",
    @SerializedName("odpt:railwayTitle") val railwayTitle: Map<String, String> = mapOf(),
    ...
    @SerializedName("odpt:stationOrder") val stationOrder: List<StationOrder> = listOf()
)
